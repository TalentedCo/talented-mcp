...
const registrations: Registration[] = [
  ...
  { name: "list_jobs", title: "List Jobs", description: "List compact job metadata in one accessible company, with safe filters. Responses intentionally use bounded descriptionPreview and counts, not full HTML job descriptions, interview descriptions, questions, or hiring-plan competencies; call get_job before ranking candidates or explaining fit.", schema: listJobsSchema, handler: listJobsHandler },
  { name: "get_job", title: "Get Job", description: "Get one accessible job as the canonical detail/context call, including bounded description text, scoringNote, progression mode and auto-progress threshold, stage meanings, automation flags, and active hiring-plan competencies.", schema: getJobSchema, handler: getJobHandler },
